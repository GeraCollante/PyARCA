...
from pyafipws.utils import NUMERICO as N
...
ENCABEZADO = [
    ...
    ("imp_total", (15, 3), IMPORTE),
    ("imp_tot_conc", (15, 3), IMPORTE),
    ("imp_neto", (15, 3), IMPORTE),
    ("impto_liq", (15, 3), IMPORTE),
    ("impto_liq_nri", (15, 3), IMPORTE),
    ("imp_op_ex", (15, 3), IMPORTE),
    ("impto_perc", 15, IMPORTE),
    ("imp_iibb", (15, 3), IMPORTE),
    ("impto_perc_mun", (15, 3), IMPORTE),
    ("imp_internos", (15, 3), IMPORTE),
    ("imp_trib", (15, 3), IMPORTE),
    ("moneda_id", 3, A),
    ("moneda_ctz", (10, 6), IMPORTE),  # 10,6
    ...
    ("descuento", (15, 3), IMPORTE),
    ("cbt_desde", 8, N),
    ("cbt_hasta", 8, N),
    ("concepto", 1, N),  # 1:bienes, 2:servicios,...
    ("no_usar", (15, 3), IMPORTE),
    ("imp_iva", (15, 3), IMPORTE),
    ("emision_tipo", 4, A),
    ("imp_subtotal", (15, 3), IMPORTE),
    ("cat_iva", 2, N),
    ("tipo_cbte", 3, N),
    ("punto_vta", 5, N),  # FCE
    ("tipo_cod_aut", 1, A),
...
IVA = [
    ...
    ("iva_id", 5, N),
    ("base_imp", (15, 3), IMPORTE),
    ("importe", (15, 3), IMPORTE),
]
...
def escribir_linea_txt(dic, formato):
    ...
    for (clave, longitud, tipo) in formato:
        ...
        try:
            ...
            raise ValueError(
                f"Error al escribir campo {clave} val '{valor}': {str(e)}"
            )
    return linea + "\n"
