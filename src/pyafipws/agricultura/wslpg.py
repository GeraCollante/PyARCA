...
ENCABEZADO = [
    ...
    ("comision_corredor", 5, IMPORTE, 2),  # 3.2
    ("fecha_precio_operacion", 10, A),  # 26/02/2013
    ("precio_ref_tn", 17, IMPORTE, 3),  # 4.3
    ("cod_grado_ref", 2, A),
    ("cod_grado_ent", 2, A),
    ("factor_ent", 6, IMPORTE, 3),  # 3.3
    ("precio_flete_tn", 17, IMPORTE, 2),  # 5.2
    ("cont_proteico", 6, IMPORTE, 3),  # 3.3
    ("alic_iva_operacion", 5, IMPORTE, 2),  # 3.2
    ("campania_ppal", 4, N),
    ...
    ("coe_ajustado", 12, N),
    ("estado", 2, A),
    ("total_deduccion", 17, IMPORTE, 2),  # 17.2
    ("total_retencion", 17, IMPORTE, 2),  # 17.2
    ("total_retencion_afip", 17, IMPORTE, 2),  # 17.2
    ("total_otras_retenciones", 17, IMPORTE, 2),  # 17.2
    ("total_neto_a_pagar", 17, IMPORTE, 2),  # 17.2
    ("total_iva_rg_4310_18", 17, IMPORTE, 2),  # 17.2 WSLPGv1.20
    ("total_pago_segun_condicion", 17, IMPORTE, 2),  # 17.2
    ("fecha_liquidacion", 10, A),
    ("nro_op_comercial", 10, N),
    ("precio_operacion", 17, IMPORTE, 3),  # 17.3
    ("subtotal", 17, IMPORTE, 2),  # 17.2
    ("importe_iva", 17, IMPORTE, 2),  # 17.2
    ("operacion_con_iva", 17, IMPORTE, 2),  # 17.2
    ...
    ("nro_formulario", 12, N),
    # datos devuetos:
    ("total_iva_10_5", 17, IMPORTE, 2),  # 17.2
    ("total_iva_21", 17, IMPORTE, 2),  # 17.2
    ("total_retenciones_ganancias", 17, IMPORTE, 2),  # 17.2
    ("total_retenciones_iva", 17, IMPORTE, 2),  # 17.2
    ("datos_adicionales", 400, A),  # max 400 desde WSLPGv1.2
    # Campos agregados WSLPGv1.5 (ajustes):
    ("iva_deducciones", 17, IMPORTE, 2),  # 17.2
    ("subtotal_deb_cred", 17, IMPORTE, 2),  # 17.2
    ("total_base_deducciones", 17, IMPORTE, 2),  # 17.2
    # Campos agregados WSLPGv1.6 (liquidación secundaria base):
    ("cantidad_tn", 11, IMPORTE, 3),  #  8.3
    ("nro_act_vendedor", 5, N),
    # Campos agregados WSLPGv1.9 (liquidación secundaria base):
    ("total_deducciones", 19, IMPORTE, 2),
    ("total_percepciones", 19, IMPORTE, 2),
]
...
RETENCION = [
    ...
    ("base_calculo", 17, IMPORTE, 2),  # 8.2
    ("alicuota", 6, IMPORTE, 2),  # 3.2
    ("nro_certificado_retencion", 14, N),
    ("fecha_certificado_retencion", 10, A),
    ("importe_certificado_retencion", 17, IMPORTE, 2),  # 17.2
    ("importe_retencion", 17, IMPORTE, 2),  # 17.2
]
...
DEDUCCION = [
    ...
    ("dias_almacenaje", 4, N),
    ("reservado1", 6, IMPORTE, 3),
    ("comision_gastos_adm", 5, IMPORTE, 2),  # 3.2
    ("base_calculo", 17, IMPORTE, 2),  # 8.2
    ("alicuota", 6, IMPORTE, 2),  # 3.2
    ("importe_iva", 17, IMPORTE, 2),  # 17.2
    ("importe_deduccion", 17, IMPORTE, 2),  # 17.2
    ("precio_pkg_diario", 17, IMPORTE, 8),  # 3.8, ajustado WSLPGv1.2
]
...
PERCEPCION = [
    ...
    ("base_calculo", 17, IMPORTE, 2),  # 8.2
    ("alicuota", 6, IMPORTE, 2),  # 3.2
    ("importe_final", 19, IMPORTE, 2),  # 17.2 (LPG WSLPGv1.16)
]
...
AJUSTE = [
    ...
    ("importe_ajustar_iva_0", 15, IMPORTE, 2),  # 11.2
    ("concepto_importe_iva_105", 20, A),
    ("importe_ajustar_iva_105", 15, IMPORTE, 2),  # 11.2
    ("concepto_importe_iva_21", 20, A),
    ("importe_ajustar_iva_21", 15, IMPORTE, 2),  # 11.2
    ("diferencia_peso_neto", 8, N),
    ("diferencia_precio_operacion", 17, IMPORTE, 3),  # 17.3
    ("cod_grado", 2, A),
    ("val_grado", 4, IMPORTE, 3),  # 1.3
    ("factor", 6, IMPORTE, 3),  # 3.3
    ("diferencia_precio_flete_tn", 7, IMPORTE, 2),  # 5.2
    ...
    ("total_otras_retenciones", 17, IMPORTE, 2),  # 17.2
    ("total_neto_a_pagar", 17, IMPORTE, 2),  # 17.2
    ("total_iva_rg_4310_18", 17, IMPORTE, 2),  # 17.2
    ("total_pago_segun_condicion", 17, IMPORTE, 2),  # 17.2
    ("iva_calculado_iva_0", 15, IMPORTE, 2),  # 15.2
    ("iva_calculado_iva_105", 15, IMPORTE, 2),  # 15.2
    ("iva_calculado_iva_21", 15, IMPORTE, 2),  # 15.2
]
...
CERTIFICACION = [
    ...
    ("monto_almacenaje", 10, IMPORTE, 2),
    ("monto_acarreo", 10, IMPORTE, 2),
    ("monto_gastos_generales", 10, IMPORTE, 2),
    ("monto_zarandeo", 10, IMPORTE, 2),
    ("porcentaje_secado_de", 5, IMPORTE, 2),
    ("porcentaje_secado_a", 5, IMPORTE, 2),
    ("monto_secado", 10, IMPORTE, 2),
    ("monto_por_cada_punto_exceso", 10, IMPORTE, 2),
    ("monto_otros", 10, IMPORTE, 2),
    ("reservado_calidad", 35, A),  # ver subestructura WSLPGv1.10
    ("peso_neto_merma_volatil", 10, IMPORTE, 2),
    ("porcentaje_merma_secado", 5, IMPORTE, 2),
    ("peso_neto_merma_secado", 10, IMPORTE, 2),
    ("porcentaje_merma_zarandeo", 5, IMPORTE, 2),
    ("peso_neto_merma_zarandeo", 10, IMPORTE, 2),
    ("peso_neto_certificado", 10, IMPORTE, 2),  # WSLPGv1.9 2 decimales!
    ("servicios_secado", 8, IMPORTE, 3),
    ("servicios_zarandeo", 8, IMPORTE, 3),
    ("servicios_otros", 7, IMPORTE, 3),
    ...
    # 'pesosResumen'
    ("peso_bruto_certificado", 10, IMPORTE, 2),
    ("peso_merma_secado", 10, IMPORTE, 2),
    ("peso_merma_zarandeo", 10, IMPORTE, 2),
    # peso_neto_certificado definido arriba
    # serviciosResumen
    ("importe_iva", 10, IMPORTE, 2),
    ("servicio_gastos_generales", 10, IMPORTE, 2),
    ("servicio_otros", 10, IMPORTE, 2),
    ("servicio_total", 10, IMPORTE, 2),
    ("servicio_zarandeo", 10, IMPORTE, 2),
    # planta
    ...
    ("servicios_conceptos_no_gravados", 10, IMPORTE, 2),
    ("servicios_percepciones_iva", 10, IMPORTE, 2),
    ("servicios_otras_percepciones", 10, IMPORTE, 2),
]
...
CTG = [  # para cgAutorizarDeposito (WSLPGv1.6)
    ...
    ("porcentaje_secado_humedad", 5, IMPORTE, 2),
    ("importe_secado", 10, IMPORTE, 2),
    ("peso_neto_merma_secado", 10, IMPORTE, 2),
    ("tarifa_secado", 10, IMPORTE, 2),
    ("importe_zarandeo", 10, IMPORTE, 2),
    ("peso_neto_merma_zarandeo", 10, IMPORTE, 2),
    ("tarifa_zarandeo", 10, IMPORTE, 2),
    ("peso_neto_confirmado_definitivo", 10, IMPORTE, 2),
]
...
CALIDAD = [  # para cgAutorizar y cgInformarCalidad (WSLPGv1.10)
    ...
    ("valor_grado", 4, IMPORTE, 3),  # solo para cod_grado F1 F2 ...
    ("valor_contenido_proteico", 5, IMPORTE, 3),
    ("valor_factor", 6, IMPORTE, 3),
]
...
class WSLPG(BaseWS):
    ...
    Version = "{} {}".format(__version__, HOMO and "Homologación" or "")
    ...
    def Conectar(
        ...
        if ok:
            ...
            try:
                ...
                from pyafipws.agricultura import wslpg_datos
                ...
                self.Traceback = f"Localidades en BD: {len(wslpg_datos.LOCALIDADES)}"
    ...
    def __analizar_errores(self, ret):
        ...
        if errores:
            self.Errores = [
                "{codigo}: {descripcion}".format(**err["error"]) for err in errores
            ]
            self.errores = [
                {
        ...
        if liq:
            ...
            if ajuste:
                ...
                for it in liq.get("importes", liq.get("importe")):
                    ...
                    tasa = "iva_{}".format(str(it["alicuota"]).replace(".", "").strip())
                    self.params_out[f"concepto_importe_{tasa}"] = it["concepto"]
                    self.params_out[f"importe_ajustar_{tasa}"] = it["importe"]
                    self.params_out[f"iva_calculado_{tasa}"] = it["ivaCalculado"]
        ...
        for k in ("ajusteDebito", "ajusteCredito"):
            if k not in self.ajuste:
                ...
                for tasa in ("0", "105", "21"):
                    ...
                    self.ajuste[k][f"importeAjustar{tasa_lsg}"] = self.ajuste[k][
                        f"importeAjustarIva{tasa}"
                    ]
                    self.ajuste[k][f"conceptoIva{tasa_lsg}"] = self.ajuste[k][
                        f"conceptoImporteIva{tasa}"
                    ]
    ...
    def BuscarLocalidades(self, cod_prov, cod_localidad=None, consultar=True):
        ...
        from pyafipws.agricultura import wslpg_datos as datos

        if str(cod_localidad) not in datos.LOCALIDADES and consultar:
    ...
    def CrearPlantillaPDF(self, papel="A4", orientacion="portrait"):
        ...
        t = Template(
            ...
            title=f"F 1116 B/C {self.NroOrden}",
            author=f"CUIT {self.Cuit}",
            subject="COE {}".format(self.params_out.get("coe")),
            keywords="AFIP Liquidacion Electronica Primaria de Granos",
            creator=f"wslpg.py {__version__} (http://www.PyAfipWs.com.ar)",
        )
        self.template = t
        return True
    ...
    def ProcesarPlantillaPDF(
        ...
        try:
            ...
            for copia in range(1, num_copias + 1):
                ...
                f.add_page()
                f.set("copia", copias.get(copia, f"Adicional {copia}"))
                ...
                f.set(
                    "valor_grado_ent",
                    "{} {}".format(cod_grado_ent or "", val_grado_ent or ""),
                )
                f.set(
                    "cont_proteico",
                ...
                f.set("procedencia", f"{localidad} - {provincia}")
                ...
                if not self.datos.get("lugar_y_fecha"):
                    ...
                    lugar = f"{localidad} - {provincia} "
                    fecha = datetime.datetime.today().strftime("%d/%m/%Y")
                    f.set("lugar_y_fecha", f"{fecha}, {lugar}")
            ...
            ex = utils.exception_info()
            try:
                f.set("anulado", "{name}:{lineno}".format(**ex))
            except Exception:
                pass
            self.Excepcion = ex["msg"]
            self.Traceback = ex["tb"]
...
def main():
    global DEBUG, XML, CONFIG_FILE, TIMEOUT, HOMO, conf_dbf
    ...
    try:
        ...
        if not ta:
            sys.exit(f"Imposible autenticar con WSAA: {wsaa.Excepcion}")
        ...
        if "--autorizar" in sys.argv:
            ...
            if int(dic["nro_orden"]) == 0 and "--testing" not in sys.argv:
            ...
            print(
                "Liquidacion: pto_emision={} nro_orden={} nro_act={} tipo_op={}".format(
        ...
        if "--consultar" in sys.argv:
            ...
            print(
                f"Consultando: pto_emision={pto_emision} nro_orden={nro_orden} coe={coe}"
            )
            if "--lsg" in sys.argv:
        ...
        if "--consultar_ajuste" in sys.argv:
            ...
            print(
                f"Consultando: pto_emision={pto_emision} nro_orden={nro_orden} nro_contrato={nro_contrato}"
            )
        ...
        if "--ult" in sys.argv:
            try:
                ...
                pto_emision = 1
            print(
                f"Consultando ultimo nro_orden para pto_emision={pto_emision}",
                end=" ",
            )
            if "--lsg" in sys.argv:
                print("LSG")
        ...
        if "--autorizar-lsg" in sys.argv:
            ...
            print(
                "Liquidacion Secundaria: pto_emision={} nro_orden={}".format(
                    wslpg.liquidacion["ptoEmision"],
                    wslpg.liquidacion["nroOrden"],
                )
            )
        ...
        if "--autorizar-anticipo" in sys.argv:
            ...
            print(
                "Liquidacion Primaria (Ant): pto_emision={} nro_orden={}".format(
                    wslpg.liquidacion["ptoEmision"],
                    wslpg.liquidacion["nroOrden"],
                )
            )
        ...
        if "--autorizar-cg" in sys.argv:
            ...
            print(
                "Certificacion: pto_emision={} nro_orden={} tipo={}".format(
        ...
        if "--informar-calidad" in sys.argv:
            ...
            print(f"Informar Calidad: coe={coe} ")
        ...
        if "--pdf" in sys.argv:
            ...
            for num_formato, (formato, clave) in enumerate(formatos):
                ...
                salida = os.path.join(d, f"{fn}.pdf")
