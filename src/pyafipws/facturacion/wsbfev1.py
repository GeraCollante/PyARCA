...
class WSBFEv1(BaseWS):
    ...
    def GetParamUMed(self):
        ...
        for u in result["BFEResultGet"]:
            ...
            umeds.append(umed)
        return ["{id}: {ds} ({vig_desde} - {vig_hasta})".format(**p) for p in umeds]
        ...
        for m in result["BFEResultGet"]:
            ...
            try:
                ...
                if m is None:
                    ...
                    # print u
            mons.append(mon)
        return ["{id}: {ds} ({vig_desde} - {vig_hasta})".format(**p) for p in mons]
    ...
    def GetParamTipoIVA(self):
        ...
        for i in result["BFEResultGet"]:
            ...
            try:
                ...
                raise
        return ["{id}: {ds} ({vig_desde} - {vig_hasta})".format(**p) for p in ivas]
    ...
    def GetParamTipoDoc(self):
        ...
        for d in result["BFEResultGet"]:
            ...
            try:
                ...
                raise
        return ["{id}: {ds} ({vig_desde} - {vig_hasta})".format(**d) for d in docs]
    ...
    def GetParamTipoCbte(self):
        ...
        for t in result["BFEResultGet"]:
            ...
            try:
                ...
                pass
        return ["{id}: {ds} ({vig_desde} - {vig_hasta})".format(**p) for p in tipos]
    ...
    def GetParamNCM(self):
        ...
        for n in result["BFEResultGet"]:
            ...
            try:
                ...
                pass
        return ["{id}: {ds} ({vig_desde} - {vig_hasta})".format(**p) for p in ncms]
    ...
    def GetParamZonas(self):
        ...
        for z in result["BFEResultGet"]:
            ...
            try:
                ...
                pass
        return ["{id}: {ds} ({vig_desde} - {vig_hasta})".format(**p) for p in zonas]
...
class WSBFE(WSBFEv1):
    ...
    def __init__(self):
        ...
        self.Version = "{} {} WSBFEv1".format(__version__, HOMO and "Homologación" or "")
...
def main():
    ...
    if "--register" in sys.argv or "--unregister" in sys.argv:
        ...
        wsbfev1.Conectar(cache, wsdl, proxy, wrapper, cacert)
