...
class WSRemHarina(BaseWS):
    ...
    def ConsultarPaises(self, sep="||"):
        ...
        return [
            (
                f"{sep} {{codigo}} {sep} {{cuit}} {sep} {{nombre}} {sep} {{tipoSujeto}} {sep}"
            ).format(**it)
            if sep
            else it
            for it in lista
...
def main():
    ...
    try:
        ...
        if "--ult" in sys.argv:
            ...
            rec = {}
            print(
                f"Consultando ultimo remito pto_emision={pto_emision} tipo_comprobante={tipo_comprobante}"
            )
        ...
        if "--consultar" in sys.argv:
            if "--cargar" not in sys.argv:
                try:
                    ...
                    cod_remito = None
            print(
                "Consultando remito cod_remito={} nro_comprobante={}".format(rec.get("cod_remito"), rec.get("nro_comprobante"))
            )
